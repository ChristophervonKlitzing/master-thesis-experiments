...
from .flow_transform import FlowRecipe, FlowTransform, create_flow_transform

from .distrax_with_extra import (ChainWithExtra)
from .build_coupling_bijector import build_split_coupling_bijector
from .act_norm import build_act_norm_layer
...
def build_flow_transform(config: FlowDistConfig) -> FlowTransform:
    recipe = create_flow_recipe(config)
    flow = create_flow_transform(recipe)
    return flow
